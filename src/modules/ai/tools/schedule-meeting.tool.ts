...
export class ScheduleMeetingTool implements AgentTool<
  ScheduleMeetingInput,
  SanitizedMeetingResult
> {
  ...
  readonly toolDefinition = {
    ...
    parameters: {
      ...
      properties: {
        ...
        startTime: {
          type: 'string',
          description: 'ISO 8601 start date-time of the meeting (required)',
        },
        endTime: {
          type: 'string',
          description: 'ISO 8601 end date-time of the meeting (required)',
        },
        description: {
          type: 'string',
        ...
        projectId: {
          type: 'string',
          description: 'Optional UUID of the project to link this meeting to',
        },
        taskId: {
          type: 'string',
          description: 'Optional UUID of the task to link this meeting to',
        },
        createGoogleMeet: {
          type: 'boolean',
  ...
  async execute(
    ...
    try {
      const meeting = await this.service.createMeeting(context.organizationId, context.userId, {
        title: input.title,
