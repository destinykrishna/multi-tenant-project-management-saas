...
-- CreateEnum
CREATE TYPE "EntityType" AS ENUM ('ORGANIZATION', 'PROJECT', 'TASK', 'COMMENT', 'USER');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('CREATED', 'UPDATED', 'DELETED', 'TASK_STATUS_CHANGED', 'TASK_ASSIGNED', 'MEMBER_ADDED', 'MEMBER_REMOVED');
